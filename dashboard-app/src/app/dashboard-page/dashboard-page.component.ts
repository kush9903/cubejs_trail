...
export class DashboardPageComponent implements OnInit {
  ...
  timeDimensions: [],
  order: {
    "Casedetails.aref": "asc"
  },
  filters: [
    {
      member: "Agentdetails.aref",
      operator: "equals",
      values: [
        "indsuperadmin"
      ]
  ...
  private doughnutQuery = new BehaviorSubject({
    measures: ['Casedetails.totalreceiptamount'],
    timeDimensions: [
      {
  ...
  changeDateRange = (value) => {
    this.query.next({
      ...this.query.value,
      //timeDimensions: [{ dimension: "Casedetails.fieldfollowupdate"}]
    });
  };
  public cards = [];
  public KPICards = [
    {
      title: 'ORDERS',
      query: { dimensions: ["Agentdetails.aref"] },
      difference: 'Orders',
      progress: false,
      duration: 2.25,
    },
    {
      title: 'TOTAL USERS',
      query: { measures: ['Casedetails.totalreceiptamount'] },
      difference: 'Users',
      progress: false,
      duration: 2.5,
    },
